...
# direction = in
zhang.in = as.data.frame(read.csv("../../../Zhang et al, 2021, PNAS/analyses/ICELLNET_RNA/LR_spé_tumC_DEGin_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
young.in = as.data.frame(read.csv("../../../Young et al_2018_Kidney/analyses/3_Downstream_analysis/ICELLNET_RNA/LR_spé_tumC_DEGin_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
soumelis.in =as.data.frame(read.csv("../3_Downstream_analysis/ICELLNET_RNA/LR_spé_tumC_DEGin_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
...
# direction = out
zhang.out = as.data.frame(read.csv("../../../Zhang et al, 2021, PNAS/analyses/ICELLNET_RNA/LR_spé_tumC_DEGout_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
young.out = as.data.frame(read.csv("../../../Young et al_2018_Kidney/analyses/3_Downstream_analysis/ICELLNET_RNA/LR_spé_tumC_DEGout_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
soumelis.out = as.data.frame(read.csv("../3_Downstream_analysis/ICELLNET_RNA/LR_spé_tumC_DEGout_thresh_1.5_ALL_CELLS_2022-10-26.csv"))
...
overlap %>% unlist() %>% as.data.frame() %>% write.csv( "IN_DEG_overlap_VD_20221026.csv")
...
#meaning = c("ZYS","ZY", "ZS", "YS", "Z", "Y", "S")
names(overlap) <- c("ZYS","ZY", "ZS", "YS", "Z", "Y", "S")
overlap %>% unlist() %>% as.data.frame() %>% write.csv( "OUT_DEG_overlap_VD_20221026.csv")
...
LR.in=read.csv("IN_DEG_overlap_VD_20221026.csv")

icell.zhang.in=as.data.frame(read.csv("../../../Zhang et al, 2021, PNAS/analyses/ICELLNET_RNA/ICELLNET_TumC_Scores_in_2022-10-26.csv"))
icell.young.in = as.data.frame(read.csv("../../../Young et al_2018_Kidney/analyses/3_Downstream_analysis/ICELLNET_RNA/ICELLNET_LR_TumC_Scores_in_2022-10-26.csv"))
icell.soumelis.in =as.data.frame(read.csv("../3_Downstream_analysis/ICELLNET_RNA/ICELLNET_LR_TumC_Scores_in_2022-10-26.csv"))
...
# Zhang dataset
icell.zhang.in2=icell.zhang.in[rownames(icell.zhang.in)%in%LR.in[1:11,2],]
icell.zhang.in2=icell.zhang.in2[LR.in[1:11,2],]
...
icell.zhang.in2=icell.zhang.in[rownames(icell.zhang.in)%in%LR.in[12:20,2],]
icell.zhang.in2=icell.zhang.in2[LR.in[12:20,2],]
Heatmap(as.matrix(icell.zhang.in2), cluster_rows = F, cluster_columns = F, clustering_method_rows = "ward.D", name="Score",
        clustering_distance_rows = "euclidean", show_column_dend = T , show_row_dend = T, show_column_names = T , show_row_names = T,
...
# Young dataset
icell.young.in2=icell.young.in[rownames(icell.young.in)%in%LR.in[1:11,2],]
icell.young.in2=icell.young.in2[LR.in[1:11,2],]
icell.young.in2=icell.young.in2[which(rowSums(icell.young.in2)>0),]
Heatmap(as.matrix(icell.young.in2), cluster_rows = F, cluster_columns = F, clustering_method_rows = "ward.D", name="Score",
        clustering_distance_rows = "euclidean", show_column_dend = T , show_row_dend = T, show_column_names = T , show_row_names = T,
        column_title =paste0("young-in_shared"), col = col_fun,
        row_names_gp = gpar(fontsize =10))


icell.young.in2=icell.young.in[rownames(icell.young.in)%in%LR.in[21:22,2],]
Heatmap(as.matrix(icell.young.in2), cluster_rows = F, cluster_columns = F, clustering_method_rows = "ward.D", name="Score",
        clustering_distance_rows = "euclidean", show_column_dend = T , show_row_dend = T, show_column_names = T , show_row_names = T,
...
# Soumelis dataset
icell.soumelis.in2=icell.soumelis.in[rownames(icell.soumelis.in)%in%LR.in[1:11,2],]
icell.soumelis.in2=icell.soumelis.in2[LR.in[1:11,2],]
...
icell.soumelis.in2=icell.soumelis.in[rownames(icell.soumelis.in)%in%LR.in[23:33,2],]
Heatmap(as.matrix(icell.soumelis.in2), cluster_rows = F, cluster_columns = F, clustering_method_rows = "ward.D", name="Score",
        clustering_distance_rows = "euclidean", show_column_dend = T , show_row_dend = T, show_column_names = T , show_row_names = T,
        column_title =paste0("soumelis-in"), col = col_fun,
        row_names_gp = gpar(fontsize =10))
...
LR.out=read.csv("OUT_DEG_overlap_VD_20221026.csv")

icell.zhang.out=as.data.frame(read.csv("../../../Zhang et al, 2021, PNAS/analyses/ICELLNET_RNA/ICELLNET_TumC_Scores_out_2022-10-26.csv"))
icell.young.out = as.data.frame(read.csv("../../../Young et al_2018_Kidney/analyses/3_Downstream_analysis/ICELLNET_RNA/ICELLNET_LR_TumC_Scores_out_2022-10-26.csv"))
icell.soumelis.out =as.data.frame(read.csv("../3_Downstream_analysis/ICELLNET_RNA/ICELLNET_LR_TumC_Scores_out_2022-10-26.csv"))
...
icell.zhang.out2=icell.zhang.out[rownames(icell.zhang.out)%in%LR.out[1:25,2],]
icell.zhang.out2=icell.zhang.out2[LR.out[1:25,2],]
...
icell.young.out2=icell.young.out[rownames(icell.young.out)%in%LR.out[1:25,2],]
icell.young.out2=icell.young.out2[LR.out[1:25,2],]
...
icell.soumelis.out2=icell.soumelis.out[rownames(icell.soumelis.out)%in%LR.out[1:25,2],]
icell.soumelis.out2=icell.soumelis.out2[LR.out[1:25,2],]
